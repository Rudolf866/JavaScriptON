...
let appData = {
    ...
    income: [],
    savings: true,
    chooseExpenses: function() { // обращение appData.chooseExpenses()
        for (let i = 0; i < 2; i++) {
    ...
    chooseIncome: function() {
        ...
        if (isNaN(items) && items == ' ' && items != null && items == false) {
            appData.income = items.split(', '); //Переводит строку в массив
